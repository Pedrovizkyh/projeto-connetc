  ...
  return (
    <>
      <header className={s.header}>
        ...
        <img className={s.imgUser} src="https://i.pinimg.com/474x/f1/39/dc/f139dc89e5b1ad0818f612c7f33200a5.jpg" alt="Imagem do usuário" onClick={() => setMenuAberto(!menuAberto)}/>
      </header>
      <nav className={menuAberto ? s.navUser : s.closedNavUser}>
        <Link to={"/usuario"} onClick={() => setMenuAberto(false)}>Pedro Bastos</Link>
